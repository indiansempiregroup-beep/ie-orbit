# Lead every public plan description with the white-label customer app.
...
def sync_white_label_plan_copy(apps, schema_editor):
...
class Migration(migrations.Migration):
    dependencies = [
        ("platform_admin", "0021_sync_launch_plan_packages"),
    ]

    operations = [
        migrations.RunPython(sync_white_label_plan_copy, noop_reverse),
    ]
