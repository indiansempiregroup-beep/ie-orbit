...
class ServiceCatalogPermission(BasePermission):
    message = (
        "Service catalog access requires tenant ownership, platform admin, "
        "or authorized business role."
    )
    write_permissions = {"service:write", "service:manage", "business:manage"}
