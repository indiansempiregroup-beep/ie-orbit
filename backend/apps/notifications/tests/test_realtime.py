...
from apps.notifications.services.realtime import publish_notification_created, user_notification_channel
...
def test_publish_notification_created_publishes_user_channel() -> None:
    ...
    with patch("apps.notifications.services.realtime.get_redis_connection", return_value=redis_client):
