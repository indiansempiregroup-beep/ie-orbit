...
const styles = StyleSheet.create({
  ...
  reviewItem: { paddingBottom: spacing.sm },
  rating: { ...typography.title, fontSize: 16, color: colors.primary, paddingHorizontal: spacing.md },
  comment: { ...typography.body, color: colors.mutedForeground, marginTop: spacing.xs, lineHeight: 20, paddingHorizontal: spacing.md, paddingBottom: spacing.md },
});
