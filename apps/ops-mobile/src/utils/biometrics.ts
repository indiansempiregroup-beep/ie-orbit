...
const REFRESH_KEY = 'ie.ops.biometric.refresh';
const PROMPTED_KEY = 'ie.ops.biometric.prompted';
...
/** Clear older password-based biometric keys if present. */
export async function migrateLegacyBiometricKeys() {
  const legacyKeys = [
    'ie:ops:biometric:enabled',
    'ie:ops:biometric:email',
    'ie:ops:biometric:password',
    'ie:ops:biometric:prompted',
    'ie.ops.biometric.password',
  ];
