...
export function AuthStack() {
  return (
    <Stack.Navigator screenOptions={{ headerShown: false }}>
      ...
      <Stack.Screen name="RegisterWizard" component={RegisterWizardScreen} options={{ headerShown: true, title: 'Register business' }} />
      ...
      <Stack.Screen name="AcceptInvitation" component={AcceptInvitationScreen} options={{ headerShown: true, title: 'Accept invitation' }} />
    </Stack.Navigator>
  );
}
